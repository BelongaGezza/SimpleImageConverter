...
v0.2.0 has been successfully released with STEP format support.
...
- **STEP Tests:** 8 integration tests (all passing)
...
*v0.2.0 is now released. Excellent work by the entire team!*
